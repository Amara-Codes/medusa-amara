...
const SecretGiftTemplate = () => {
  ...
  const handleDownload = (): void => {
    ...
    if (canvas) {
      ...
      link.download = `${qrText || "qr-code"}.png`;
      link.click();
    }
  };
        ...
        <div className="mb-16 small:mx-12">
          ...
          <div>
            <p className="text-koiYellow text-xl small:text-2xl">
              Congratulations! You’ve found the sticker we hid in Siem Reap and
              made it to this page. Add your name and surname, generate your
              personalized QR code, download it, and save it to your gallery.
              Show your QR code in our Taproom, and you’ll get a 20% discount on
              all your orders for the entire evening. The promotion is valid for
              one month starting from the opening party. Stay tuned!
            </p>
            <div className="mt-4 text-ui-fg-muted text-lg small:text-xl">
              <p>
                Please note: Make sure to use your real name, as we will ask you
                to confirm your identity in the Taproom.
              </p>
              <p>
                <strong>
                  No data is saved to our database during this process. Your
        ...
        <div className="flex small:mx-12 justify-center">
          <div className="w-full">
            ...
            >
              ...
              <button
                type="submit"
                className={`py-2 px-4 rounded text-white font-bold transition ${
                  name.trim()
                    ? "bg-koiRed hover:bg-koiOrange cursor-pointer"
            ...
            {qrText && (
              <div className="mt-8 flex flex-col items-center">
                ...
                <button
                  ...
                  className="mt-4 text-white py-2 px-4 rounded bg-koiRed hover:bg-koiOrange transition font-bold"
                >
                  Download QR Code
                </button>
              </div>
