      ...
      <div className="content-container flex flex-col w-full">
        <div className="flex flex-col gap-y-6 small:flex-row items-start gap-x-8 py-40">
          <div>
            ...
            <div className="mt-4">
              <p className="text-xl font-bold">Amara Beer Lab</p>
            ...
            <div className="mt-4">
              ...
              <div className="flex gap-x-4 text-ui-fg-base mt-4">
                <Link href="https://www.instagram.com/amarabeerlab/" rel="noopener noreferrer" target="_blank" className="">
                ...
                <Link href="https://www.youtube.com/@amarabeerlab" rel="noopener noreferrer" target="_blank" className="">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
                ...
                <Link href="https://www.tiktok.com/@amara.beer.lab" rel="noopener noreferrer" target="_blank" className="">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
