    ...
    >
      <div className="w-full">
        <div className="mb-8 small:mx-12">
          <h1 className="mb-8 font-extrabold text-4xl text-center text-koiRed small:text-8xl small:text-start font-fatboy" data-testid="news-page-title">News</h1>
        ...
        <div className="small:mx-12">
          <CTABlock
            ...
            titleSize="h3"
            titleCss="text-6xl text-ui-fg-base mb-16 lg:mg-0 text-koiRed font-fatboy"
