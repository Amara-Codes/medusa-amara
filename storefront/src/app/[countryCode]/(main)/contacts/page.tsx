                    ...
                    <div className="col-span-1 flex flex-col items-center text-center  lg:mx-12 lg:my-8 bg-bottom order-2 mt-16">
                        ...
                        <div className="grid grid-cols-4 gap-x-6 small:grid-cols-1 small:h-full">
                            <div className="social-wrapper">
                                ...
                                <Link href="https://www.facebook.com/profile.php?id=61571989060533" rel="noopener noreferrer" target="_blank" className="text-koiOrange" title="Facebook Link">
                            ...
                            <div className="social-wrapper">
                                ...
                                <Link href="https://www.instagram.com/amarabeerlab/" rel="noopener noreferrer" target="_blank" className="text-koiOrange" title="Instagram Link">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 16 16">
                            ...
                            <div className="social-wrapper">
                                ...
                                <Link href="https://www.youtube.com/@amarabeerlab" rel="noopener noreferrer" target="_blank" className="text-koiOrange" title="Youtube Link">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 16 16">
                            ...
                            <div className="social-wrapper">
                                ...
                                <Link href="https://www.tiktok.com/@amara.beer.lab" rel="noopener noreferrer" target="_blank" className="text-koiOrange" title="Tik Tok Link">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 16 16">
