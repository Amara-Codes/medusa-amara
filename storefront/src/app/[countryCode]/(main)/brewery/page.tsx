  ...
  return (
    <div className="pt-24 mt-32">
      ...
      <TypoParagraphBlock
        ...
        fatTextPosition="sx"
        fatTextCss="leading-relaxed text-ui-fg-base border-b-4 text-4xl font-fatboy text-koiRed"
      ...
      <TypoParagraphBlock
        ...
        fatText="Who am I?"
        fatTextPosition="dx"
        fatTextCss="leading-relaxed text-ui-fg-base border-b-8 text-4xl font-fatboy text-koiRed"
