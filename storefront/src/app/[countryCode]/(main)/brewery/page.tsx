...
import ArticlesList from "@modules/brewery/components/articles-list";
  ...
  return (
    <div className="lg:pb-48">
      ...
      <ParagraphBlock
        ...
        title="Our Beers"
        titleSize="h3"
        titleCss="fat-text leading-relaxed mb-8 lg:mb-24 text-ui-fg-base"
        imgAlt="H ring"
        imgPosition="sx"
